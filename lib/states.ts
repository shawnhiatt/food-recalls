// State list for the Feed filter (SPEC.md §8). Duplicated intentionally from
// convex/lib/states.ts's STATE_NAMES, for the same reason as lib/copy.ts's
// allergen list — frontend code doesn't import across the app/convex
// tsconfig boundary.
